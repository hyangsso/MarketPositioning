from test_code.instagram_crawler import instagram as insta
from test_code.instagram_crawler import preprocessing as pp

#keyword = input("Input Keyword: ")

# login
link_list = insta.crawl_insta_link("bugak", "tempcrawlingbot2", "asdfqwer!@#$")
